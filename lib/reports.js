...
if (Meteor.isServer) {
    ...
    Meteor.publish('reports.adminPageListWithCategory', function reportsPublication(category){
        return Reports.find({isValidated: false, category: category}, { sort: { createdAt: -1}});
    });
